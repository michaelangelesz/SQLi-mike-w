...
db.serialize(function () {
  ...
  //Make sure you really do change the user values to something simple such as "xyz" as I've shown below if you're working from the HackerU source code because you may entering the info many times in the login form.

  db.run(
    "INSERT INTO user VALUES ('xyz', 'xyz', 'User of an app with vulnerable source code')"
  )
})
